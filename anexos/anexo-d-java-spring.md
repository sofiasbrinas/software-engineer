...
`↩ Índice Geral: ../modulos/00-INDICE-GERAL.md` | `⬅ Pré-requisito: trilha completa Node/TS (Fases 0-15)`
...
## 🎓 Formações DIO (Java & Spring Boot)

A DIO relança formações de Java/Spring com parceiros corporativos com frequência — ótimo encaixe para este anexo, já que ele é cursado depois da trilha principal. Todas incluem projetos práticos de portfólio; verifique `dio.me/bootcamp` para a edição aberta no momento, já que os prazos abaixo rotacionam.

| Formação | Parceiro | Carga horária | Destaque | Link |
|---|---|---|---|---|
| Java com Inteligência Artificial | Itaú | 45h | Fundamentos até Spring Boot, com projeto de Design Patterns (GoF → Spring) e uma API com reconhecimento de fala | [dio.me/bootcamp/itau-java-com-inteligencia-artificial](https://www.dio.me/bootcamp/itau-java-com-inteligencia-artificial) |
| Java com Spring Boot | Claro | 75h | Fundamentos, TDD, arquitetura de microsserviços; projeto final publica uma API REST na nuvem com Spring Boot 3 + Java 17 + Railway | [dio.me/bootcamp/coding-the-future-claro-java-spring-boot](https://www.dio.me/bootcamp/coding-the-future-claro-java-spring-boot) |
| Desenvolvimento Java com Cloud AWS | GFT + AWS | 65h | Java, Spring Boot, SQL/NoSQL e AWS, com IA aplicada (Amazon CodeWhisperer) | [dio.me/bootcamp/coding-future-gft-aws-desenvolvimento-java-com-cloud-aws](https://www.dio.me/bootcamp/coding-future-gft-aws-desenvolvimento-java-com-cloud-aws) |
| Back-end com Java & QA | Almaviva Solutions | 64h | Fundamentos de Java, APIs REST com Spring Boot, banco de dados/SQL **e** testes (QA) — o mais completo para fechar D.1-D.6 de uma vez | buscar "Almaviva Java QA" em `dio.me/bootcamp` |
| Java com foco em IA (Spring AI) | NTT Data | 54h | Java 25 + Spring Boot 3, SOLID/Clean Code/Design Patterns aplicados ao Spring, integração com Spring AI | buscar "NTT Data Java" em `dio.me/bootcamp` |

> ⚠️ **Sobre os prazos:** bootcamps com parceria corporativa (Itaú, Claro, GFT, NTT Data, Almaviva) têm **inscrição por tempo limitado** — geralmente algumas semanas — mas essas empresas costumam abrir novas edições com frequência ao longo do ano. Se um link acima estiver com inscrições encerradas, procure a mesma parceria novamente em `dio.me/bootcamp` ou ative notificações na plataforma.
