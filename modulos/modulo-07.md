...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-06.md` | `➡ Próximo: modulo-08.md`
...
- **Bootcamp Sem Parar Corpay — Backend do Zero à Prática** ([dio.me/bootcamp/bootcamp-corpay-backend-do-zero-a-pratica](https://www.dio.me/bootcamp/bootcamp-corpay-backend-do-zero-a-pratica)) — 43h cobrindo Node.js, TypeScript, Fastify, APIs REST e Azure, com projeto de Minimal API para portfólio. *Bootcamp com parceria — inscrição por tempo limitado; empresas como a Corpay costumam reabrir edições periodicamente, vale checar `dio.me/bootcamp` se essa estiver fechada.*

---

`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-08.md`
