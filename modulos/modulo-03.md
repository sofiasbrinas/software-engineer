...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-02.md` | `➡ Próximo: modulo-04.md`
...
- **Curso JavaScript — Construa uma Pokédex do zero** ([dio.me/curso-javascript](https://www.dio.me/curso-javascript)) — formação com entrada gratuita, projeto prático consumindo API REST. *Formação (parte do plano DIO PRO para o conteúdo completo).*

---

`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-04.md`
