...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-04.md` | `➡ Próximo: modulo-06.md`
...
> 🎨 **Conexão com Design Engineering (Anexo F):** este é o ponto onde a trilha principal e o Anexo F se cruzam com mais força. O que está descrito aqui é o **mínimo** de a11y — no [`Anexo F.4 — Acessibilidade Avançada`](../anexos/anexo-f-design-engineering.md#-f4--acessibilidade-avançada) você vai fundo em WCAG AA, padrões ARIA de componentes complexos e testes com leitor de tela. Também é a hora de começar F.2 (Design Tokens) e F.3 (Prototipação/Handoff), já que ambos dependem diretamente de HTML/CSS.
...
> 🎨 No seu caso, isso já é familiar do Design Gráfico — o [`Anexo F.1`](../anexos/anexo-f-design-engineering.md#-f1--fundamentos-de-design-de-interface) sistematiza essa bagagem em critérios técnicos nomeáveis, prontos para defender em entrevista.
...
- **Guia completo de carreira Front-end da DIO** ([dio.me/articles/o-guia-completo-para-dominar-a-carreira-front-end-com-a-dio](https://www.dio.me/articles/o-guia-completo-para-dominar-a-carreira-front-end-com-a-dio)) — roadmap com trilhas de HTML, CSS, JavaScript, React e Angular (138h, 12 projetos). Útil como referência mesmo fora do escopo desta fase (seu foco é Backend), caso queira reforçar o lado visual.
- **React Developer** ([dio.me/curso-react](https://www.dio.me/curso-react)) — opcional, caso queira consumir suas próprias APIs (Fase 7) com uma interface real no portfólio. *Formação (DIO PRO).*

---

`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-06.md`
