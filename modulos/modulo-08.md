...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-07.md` | `➡ Próximo: modulo-09.md`
...
- **Database Experience** ([dio.me/bootcamp/database-experience](https://www.dio.me/bootcamp/database-experience)) — bootcamp de 54h sobre modelagem de dados, SGBD, EER e arquitetura, com MySQL e MongoDB. *Bootcamp evergreen, sem parceria de prazo fixo — costuma ficar disponível continuamente.*
- **Curso Completo Banco de Dados e SQL** ([dio.me/curso-sql](https://www.dio.me/curso-sql)) — projeto de banco de dados de um e-commerce, cobrindo DDL/DML na prática. *Curso permanente.*

---

`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-09.md`
