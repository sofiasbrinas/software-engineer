...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-13.md` | `➡ Próximo: modulo-15.md`
...
> 🎨 **Conexão com Design Engineering (Anexo F):** esta fase é onde o Projeto de Consolidação do [`Anexo F`](../anexos/anexo-f-design-engineering.md#-projeto-de-consolidação) entra em jogo — um design system documentado (tokens + component library + Storybook) integrado a um dos projetos do Portfólio Final, ou publicado como peça independente, é exatamente o tipo de diferencial que faz um README e um perfil GitHub pararem um recrutador por mais que 2 minutos.
...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-15.md`
