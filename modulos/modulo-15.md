...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-14.md` | `➡ Próximo: ../anexos/anexo-a-cronogramas.md`
...
```mermaid
graph LR
    A[Triagem de currículo] --> B[Entrevista com RH/Recrutador]
    B --> C[Teste técnico / Desafio de código]
    C --> D[Entrevista técnica com Tech Lead/Engenheiro]
    D --> E[Entrevista comportamental/cultural fit]
    E --> F[Proposta]
```
...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: ../anexos/anexo-a-cronogramas.md`
