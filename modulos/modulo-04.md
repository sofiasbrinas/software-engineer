...
`↩ Índice Geral: 00-INDICE-GERAL.md` | `⬅ Anterior: modulo-03.md` | `➡ Próximo: modulo-05.md`
...
- **TypeScript Fullstack Developer** ([dio.me/curso-typescript](https://www.dio.me/curso-typescript)) — TypeScript aplicado em front-end (React) e back-end (Node/Express), incluindo criação de API REST. *Formação (DIO PRO).*

---

`↩ Índice Geral: 00-INDICE-GERAL.md` | `➡ Próximo: modulo-05.md`
